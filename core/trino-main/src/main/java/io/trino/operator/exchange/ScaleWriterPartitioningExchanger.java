        ...
        implements LocalExchanger
{
            ...
            long maxMemoryPerTask)
    {
        ...
        this.maxMemoryPerTask = maxMemoryPerTask;
    ...
    {
        // Scale up writers when current buffer memory utilization is more than 50% of the maximum and total user
        // memory used by this query is less than maxMemoryPerTask.
        if (memoryManager.getBufferedBytes() > maxBufferedBytes * 0.5 && totalMemoryUsed.get() < maxMemoryPerTask) {
