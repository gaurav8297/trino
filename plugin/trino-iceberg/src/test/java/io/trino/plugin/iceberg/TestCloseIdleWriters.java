            ...
            throws Exception
    {
        return IcebergQueryRunner.builder()
                ...
                .setIcebergProperties(ImmutableMap.of(
                        "iceberg.target-max-file-size", "100GB",
                        "iceberg.idle-writer-min-file-size", "1MB"))
                .build();
    }
    ...
    public void testCloseIdleWriters()
    {
        ...
        try {
            ...
            @Language("SQL") String createTableSql = """
                    CREATE TABLE %s WITH (format = 'ORC', partitioning = ARRAY['shipmodeVal'])
            ...
            assertUpdate(
                    Session.builder(getSession())
                            ...
                            .setSystemProperty(IDLE_WRITER_MIN_DATA_SIZE_THRESHOLD, "5MB")
                            .build(),
                    createTableSql);
